      ...
      <div className="white-navbar" >
        <Navbar bg="" expand={false} fixed="top">
          <Container fluid className='px-5'>
            <div>
              <img src={Logo_white} alt="" width="64px" className="ms-3 cursor-pointer" onClick={() => navigate('/employer/dashboard')} />
            </div>
        ...
        <Navbar bg="" expand={false} fixed="top" style={{ height: "90px" }}>
          <Container fluid>
            <div>
              ...
              <img src="../../assets/img/Logo_white.png" onClick={() => navigate('/employer/dashboard')} alt="" width="40px" className="ms-3 cursor-pointer" />
            </div>
            ...
            <div className='d-flex gap-5'>
              {/* <div className="header-profile position-relative">
                <img src={profileImg ? profileImg : profile_pic} alt="" width="100%" height="100%" className="" style={{ cursor: "pointer", objectFit: 'cover' }} onClick={() => setShowMenu(!showMenu)} />
                {
                  showMenu && <NavbarModel show={showMenu} onHide={() => setShowMenu(false)} />
                }
              </div> */}
